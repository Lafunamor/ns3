...
_wrap_PyNs3BulkSendHelper__tp_init__1(PyNs3BulkSendHelper *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    if (PyObject_IsInstance(address, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Inet6SocketAddress, InetSocketAddress, Ipv4Address, Ipv6Address, Mac16Address, Mac48Address, Mac64Address, PacketSocketAddress), not %s", address->ob_type->tp_name);
        {
            PyObject *exc_type, *traceback;
            PyErr_Fetch(&exc_type, return_exception, &traceback);
            Py_XDECREF(exc_type);
...
_wrap_PyNs3UdpClientHelper__tp_init__4(PyNs3UdpClientHelper *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    if (PyObject_IsInstance(ip, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Inet6SocketAddress, InetSocketAddress, Ipv4Address, Ipv6Address, Mac16Address, Mac48Address, Mac64Address, PacketSocketAddress), not %s", ip->ob_type->tp_name);
        {
            PyObject *exc_type, *traceback;
            PyErr_Fetch(&exc_type, return_exception, &traceback);
            Py_XDECREF(exc_type);
...
_wrap_PyNs3ApplicationPacketProbe__tp_init__0(PyNs3ApplicationPacketProbe *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    if (self->ob_type != &PyNs3ApplicationPacketProbe_Type)
    {
